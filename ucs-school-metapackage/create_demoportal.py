...
def create_school():
	...
	if not school_exists:
		try:
			subprocess.check_call(['python', '/usr/share/ucs-school-import/scripts/create_ou', '--displayName={}'.format(SCHOOL[1]), '--not-alter-dhcpd-base', SCHOOL[0], hostname_demoschool])
